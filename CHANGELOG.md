...
### Internal
- 78 C++ suites on the Full build (75 on Lite), up from 76 and 73. The two new suites are **`test_passwordgen`** (the entropy maths and the CSPRNG draw paths) and **`test_passwordgen_panel`** (the widgets). Full offscreen `ctest` is 78/78 green.
