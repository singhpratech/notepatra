...
### Honesty
- **Bare-binary size claim corrected: 12.4 → 12.2 MB** on Linux x64, measured from the shipped release artifact (the v0.1.117 dead-code removal shrank the binary past the advertised number).
